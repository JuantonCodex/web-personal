...
var MAIN;$(function(){MAIN={init:function(){this.fnNavMenu()},fnNavMenu:function(){var i=$("#nav"),n=(i.find("li").length,i.find("li").width()),t=i.children(".arrow"),f=t.width(),e=i.find("li").index(i.find(".active")),o=e*n+(n-f)/2;t.css("left",o),i.find("li").on("mouseover",function(){var e=i.find("li").index(this),o=e*n+(n-f)/2;t.stop().animate({left:o},600)}),i.find("li").on("mouseout",function(){t.stop().animate({left:o},600)})}},MAIN.init()});
var HOME;$(function(){HOME={init:function(){this.fnSlide()},fnSlide:function(){$(".rslides").responsiveSlides({nav:!0,pagination:!0,prevText:"",nextText:""})}},HOME.init()});